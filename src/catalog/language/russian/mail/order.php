...
$_['text_new_greeting']         = 'Благодарим за интерес к товарам нахлыстового интернет магазина "%s". Ваш заказ получен и поступил в обработку.<br /> После отправки заказа вы получите уведомление об этом и почтоый номер для отслеживания отправления.';
...
$_['text_option_model']         = 'Option Model';
$_['text_option_sku']           = 'Option SKU';
