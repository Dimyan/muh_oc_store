...
function addModule() {	
	...
	//html += '  <tr>';
	//html += '      <td><?php echo $entry_admin_approved; ?></td>';
	//html += '      <td>';
	//html += '         <input type="checkbox" name="testimonial_module[' + module_row + '][testimonial_admin_approved]" value="1" checked="checked" />';
	//html += '     </td>';
	//html += '  </tr>';
