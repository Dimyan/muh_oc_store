      ...
      <div id="tab-customer-fields">
        ...
        <table class="form" style="margin-bottom:50px;">
          ...
          <tr>
            ...
            <td>
                <input type="text" name="simple_fields_main[<?php echo $field['id'] ?>][mask]" value="<?php echo !empty($field['mask']) ? $field['mask'] : '' ?>">
            </td>  
          </tr>
          <tr>
            <td>
        ...
        <table id="<?php echo $field['id'] ?>" class="form" style="margin-bottom:50px;">
          ...
          <tr>
            ...
            <td>
                <input type="text" name="simple_fields_custom[<?php echo $field['id'] ?>][mask]" value="<?php echo !empty($field['mask']) ? $field['mask'] : '' ?>">
            </td>  
          </tr>     
          <tr>
            <td>
